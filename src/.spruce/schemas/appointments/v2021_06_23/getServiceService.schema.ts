...
const getServiceServiceSchema: SpruceSchemas.Appointments.v2021_06_23.GetServiceServiceSchema  = {
...
SchemaRegistry.getInstance().trackSchema(getServiceServiceSchema)

export default getServiceServiceSchema
